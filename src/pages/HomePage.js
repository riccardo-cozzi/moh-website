                ...
                <Grid container spacing={20}>
                    ...
                    <Grid item xs={12} >
                        <Grid container spacing={10} direction="column" alignItems="center" sx={{ px: { xs: 2, sm: 6, md: 10 } }}>
                            ...
                            <Grid item sx={{ width: '100%' }} >
                                <Box>
                                    <Typography variant="h3" align='center' margin={10} sx={{ fontFamily: 'Neogen', backgroundImage: 'linear-gradient(135deg, #2e7d32 0%, #0094ae 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', display: 'block' }}> {getText(TEXT_KEYS.OUR_STORIES_TITLE, language.id)} </Typography>
                                    <Stories />
                                </Box>
                            </Grid>
                            ...
                            <Grid item sx={{ width: '100%', px: 10 }} >
                                <Box>
                                    <Typography variant="h3" align='center' margin={10} sx={{ fontFamily: 'Neogen', backgroundImage: 'linear-gradient(135deg, #2e7d32 0%, #0094ae 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', display: 'block' }}>{getText(TEXT_KEYS.OUR_PARTNERSHIPS_TITLE, language.id)}</Typography>
                                    <Partners />
